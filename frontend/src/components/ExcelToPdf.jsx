...
const ExcelToPdf = () => {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      setMessage(res.data.message || "Excel spreadsheet converted to PDF successfully.");
    ...
    <div className="max-w-4xl mx-auto py-8">
      ...
      <div className="text-center mb-10">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-semibold bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 mb-4">
          <Sparkles className="w-3.5 h-3.5" /> Fast Spreadsheet Conversion
        </div>
        ...
        <p className="text-slate-400 mt-2 text-base max-w-xl mx-auto">
          Convert your Excel spreadsheets (.xlsx, .xls) into printable, read-only PDF documents.
        </p>
      </div>
        ...
        {!download ? (
          ...
          <div className="text-center py-6">
            ...
            <div className="mt-8 pt-6 border-t border-slate-800 flex justify-center">
              ...
              >
                <RefreshCw className="w-3.5 h-3.5" /> Convert another Excel file
              </button>
            </div>
          </div>
        )}
